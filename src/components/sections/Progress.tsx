...
const stats = [
  { label: "Pain Reduction", value: "−64%", up: false, good: true },
  { label: "Flexibility", value: "+27%", up: true, good: true },
  { label: "Recovery Progress", value: "88%", up: true, good: true },
  { label: "Mobility Growth", value: "+38%", up: true, good: true },
  { label: "Posture", value: "+45%", up: true, good: true },
];

const history = [
  { date: "Jun 21", label: "Spinal Mobility Flow", tag: "Self-guided" },
  { date: "Jun 18", label: "Assisted session · Dr. Karan", tag: "Assisted" },
  { date: "Jun 15", label: "Hip Flexor Release", tag: "Self-guided" },
];
