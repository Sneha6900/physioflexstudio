...
const cards = [
  {
    ...
    desc: "Pinpoint discomfort on an interactive body map and capture intensity, duration and stiffness in seconds.",
  ...
  },
  {
    ...
    desc: "Our engine interprets pain location, severity and mobility restrictions to build your recovery blueprint.",
    className: "md:col-span-1",
  },
  {
    icon: Dumbbell,
    title: "Personalized Exercise Plans",
    desc: "Adaptive routines with stretching, mobility and strength work tuned to your body.",
    className: "md:col-span-1",
  },
  {
    icon: CalendarHeart,
    title: "Assisted Recovery Sessions",
    desc: "Book certified specialists who guide every movement safely — ideal for elderly or post-surgery recovery.",
