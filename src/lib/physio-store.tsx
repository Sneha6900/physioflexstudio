...
const physioAccounts: PhysioProfile[] = [
  ...
  },
  {
    ...
    reviews: 248,
    years: 6,
    specializations: ["Mobility Coaching", "Posture", "Desk Pain"],
...
const defaultSessions: PhysioSession[] = [
  {
    ...
    summary: "Moderate lumbar pain with stiffness after long sitting, limited forward flexion.",
    date: "2026-07-03",
    time: "9:30 AM",
  ...
  },
  {
    ...
    summary: "Stiff neck pain with tension headaches after long hours on laptop work.",
    date: "2026-07-02",
    time: "2:00 PM",
    studio: "Indiranagar Studio",
    status: "completed",
